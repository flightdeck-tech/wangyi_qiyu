#import "WangyiQiyuPlugin.h"
#import "QYSDK.h"

static NSString *const CHANNEL_NAME = @"plugins.com.tmd/qiyu";
static NSString *const EVENT_CHANNEL_NAME = @"plugins.com.tmd/event_qiyu";

@interface WangyiQiyuPlugin ()<FlutterStreamHandler, QYConversationManagerDelegate>
